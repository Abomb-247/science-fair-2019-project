...
# Choose from names in https://github.com/openai/gym/wiki/Table-of-environments
# Note that pixels have Observation space of Box(210, 160, 3) and RAM has
# observation space of Box(128,)
#gymGameName = 'Pong-RamNoframeskip-v4'
gymGameName = 'PongNoframeskip-v4'
...
class Policy(nn.Module):
    def __init__(self):
        ...
        # Note the implicit structure of 6000 pixels and 2 control signals
...
# Using Adam optimizer with learning rate lr
# Policy is an nn.Module and therefore returns parameters() to optimize
opt = torch.optim.Adam(policy.parameters(), lr=1e-3)

# TODO: create a file with learning information to capture while running and 
# analyze afterward
# Columns: iteration, episode, reward_sum, average_action_prob, game_running_time, total_running_time
