...
#model = PPO2.load("/gdrive/My Drive/science fair project/2019/BalloonFightRecord/" + modelname+".pkl")
for saveloop in range(100):
  ...
  model.save("/gdrive/My Drive/science fair project/2019/BalloonFightRecord/" + modelname)
